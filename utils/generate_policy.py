...
修车时自付额以内自己出，自付额以外的保险公司赔付" if vehicle["collision"]["selected"] else "没有选择该项目"
    tbl.cell(2, 2).text = f"自付额${vehicle['comprehensive']['deductible']}
修车时自付额以内自己出，自付额以外的保险公司赔付" if vehicle["comprehensive"]["selected"] else "没有选择该项目"
    tbl.cell(3, 2).text = "赔偿由于:机械故障,电瓶没电,钥匙被锁车内,燃油耗尽,轮胎没气造成车辆不可行驶时的免费拖车，免费充电，免费开锁服务" if vehicle["roadside"]["selected"] else "没有选择该项目"
    tbl.cell(4, 2).text = "每天$30 最多30天" if vehicle["rental"]["selected"] else "没有选择该项目"
